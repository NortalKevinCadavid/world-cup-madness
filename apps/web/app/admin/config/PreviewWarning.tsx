  ...
  if (!preview.affecting) {
    return (
      <div
        ...
        className="rounded-lg border border-win/40 bg-win/10 p-4"
      >
        <div
        ...
        >
          <div className="flex-1">
            <h3 className="text-sm font-semibold text-win">
              Safe to apply
            </h3>
            <p className="mt-1 text-sm text-win">
              {preview.summary ||
        ...
        <div className="mt-4 flex justify-end gap-2">
          ...
          <button
            ...
            className="rounded-md bg-win px-4 py-2 text-sm font-medium text-white hover:bg-win/90"
          >
            Confirm
          </button>
        </div>
    ...
    >
      ...
      >
        <div className="flex-1">
          ...
          <p className="mt-2 text-sm text-open">{preview.summary}</p>

          <details className="mt-3 rounded border border-open/40 bg-card p-2 text-xs">
            <summary className="cursor-pointer font-medium text-open">
          ...
          <label className="mt-4 flex items-center gap-2 text-sm text-open">
            <input
              type="checkbox"
              data-testid="config-preview-acknowledge"
              checked={acknowledged}
              onChange={(e) => setAcknowledged(e.target.checked)}
              className="h-4 w-4 rounded border-amber-400 text-destructive focus:ring-red-500"
            />
